...
@NoArgsConstructor
@Data
public class AdminInsertTenantMetaDTO extends AdminUpdateTenantMetaDTO {
    ...
    @Pattern(message = "管理员邮箱格式不正确", regexp = HeliumConstant.Regex.EMAIL)
    @Size(max = 255, message = "【管理员邮箱】最长255位")
    @NotBlank(message = "管理员邮箱必填")
    private String tenantAdminEmail;

    @Schema(description = "管理员手机号", requiredMode = Schema.RequiredMode.REQUIRED)
    @Pattern(message = "管理员手机号格式不正确", regexp = HeliumConstant.Regex.CHINA_MAINLAND_PHONE_NO)
