...
import cc.uncarbon.module.sys.model.request.AdminInsertSysOperateLogDTO;
...
public interface SysLogAspectExtension {
    ...
    /**
     * 保存到 DB 前
     * @param insertSysOperateLogDTO 新系统操作日志DTO
     * @param joinPoint 切点
     * @param annotation 注解实例
     * @param e 异常实例；如果没有发生异常则值为null
     * @param ret 原始方法过程，于顺利运行时的返回值
     */
    default void beforeSaving(final AdminInsertSysOperateLogDTO insertSysOperateLogDTO, final JoinPoint joinPoint, SysLog annotation, final Throwable e, Object ret) {
