...
public class SysRoleServiceImpl implements SysRoleService {
     ...
     */
    @Override
    public PageResult<SysRoleBO> adminList(AdminListSysRoleDTO dto) {
     ...
     * @param dto DTO
     */
    private void checkRepeat(AdminInsertOrUpdateSysRoleDTO dto) {
