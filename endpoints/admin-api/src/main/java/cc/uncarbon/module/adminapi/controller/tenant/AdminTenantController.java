...
public class AdminTenantController {
    ...
    public ApiResult<Void> insert(@RequestBody @Valid AdminSysTenantUpsertRequest request) {
    ...
    public ApiResult<Void> update(@RequestBody @Valid AdminSysTenantUpsertRequest request) {
        SysTenantKickOutUsersBO needKickOutUsers = sysTenantFacade.adminUpdate(request);
    ...
    public ApiResult<Void> delete(@RequestBody @Valid IdsRequest<Long> request) {
        SysTenantKickOutUsersBO needKickOutUsers = sysTenantFacade.adminDelete(request.getIds());
