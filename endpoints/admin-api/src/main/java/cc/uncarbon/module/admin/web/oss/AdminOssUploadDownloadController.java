package cc.uncarbon.module.admin.web.oss;

import cc.uncarbon.framework.core.exception.BusinessException;
import cc.uncarbon.framework.web.model.response.ApiResult;
import cc.uncarbon.module.admin.constant.AdminApiConstant;
import cc.uncarbon.module.admin.enums.AdminApiErrorEnum;
import cc.uncarbon.module.admin.util.AdminStpUtil;
...
import cc.uncarbon.module.oss.model.response.OssFileUploadResult;
...
public class AdminOssUploadDownloadController {
     ...
     */
    private OssFileUploadResult toUploadResult(OssFileInfoBO ossFileInfo, String requestUrl, String originalFilename) {
        OssFileUploadResult ret = new OssFileUploadResult()
